...
public class AccountSummary {
	...
	@FindBy(css="body > div.wrapper > div.container > div > div:nth-child(2) > div > div > h2:nth-child(1)")
	private WebElement cashAccountElement;
	...
	public boolean isTransferFundsDisplayed() {
...
public String getCashAccountText() {
		...
		String AcctText= cashAccountElement.getText();
		return AcctText;
